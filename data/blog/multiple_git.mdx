...
Alternatively, you can use the default profile in all folders except, say, `work_repo`. In this case, create one profile (work_profile), and all other folders will use your default config.
...
You are free to place your profiles in any directory; just provide the appropriate path. In this example, I'll be using the .ssh directory.
